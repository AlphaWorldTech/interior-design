        ...
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-12 xs-text-center">
              <h1 class="font-32 text-theme-colored">Faq's</h1>
            ...
            <div id="accordion1" class="panel-group accordion">
              ...
              <div class="panel">
                ...
                <div id="accordion13" class="panel-collapse collapse" role="tablist" aria-expanded="false">
                  <div class="panel-content">
                    <p>The process can take as little as 4-5 days from the time we connect with you. However, the actual timeing will depend on the condition of your paint surfaces, the type of work required, our schedule and weather conditions if the project involves exterior work.</p> <p>
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              ...
              <h2>Just call at <span class="text-theme-colored">91 9155532679, 9155532679</h2>
            </div>
          </div>
        </div>
      </div>
